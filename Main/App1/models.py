...
class ProfesionDb(models.Model):
    ...
    class Meta:
        db_table = "Profesiones" # Indicamos como se mostrará en la DB
        verbose_name = "Profesión" # Indicamos como se mostrará en el admin
        verbose_name_plural = "Profesiones" # Indicamos como se mostrará en plural en el admin
...
class AutorDb(models.Model):
    ...
    profesion = models.ManyToManyField(ProfesionDb, verbose_name="Profesion", related_name='autores')
    nacionalidad = models.CharField(verbose_name="Nacionalidad", max_length=50)
    
    # Con meta personalizamos nuestra tabla
    class Meta:
        db_table = "Autores"
        verbose_name = "Autor" # Indicamos como se mostrará en el admin
        verbose_name_plural = "Autores" # Indicamos como se mostrará en plural en el admin

    # Devolvemos un str para presentar la petición de la fk
...
class FraseDb(models.Model):
    ...
    class Meta:
        db_table = "Frases"
        verbose_name = "Frase" # Indicamos como se mostrara en el admin
        verbose_name_plural = "Frases" # Indicamos como se mostrará en plural en el admin
